...
const blogPosts = [
  {
    ...
    excerpt: "Explore the emerging trends shaping the media landscape, from AI-driven content creation to immersive experiences that are redefining audience engagement.",
  ...
  },
  {
    ...
    excerpt: "Learn how to make the most of industry events and build meaningful connections that can advance your career in media and entertainment.",
    author: "The Media Collective",
    date: "January 5, 2025",
  ...
  },
  {
    ...
    excerpt: "A recap of the insights shared at our exclusive NAB review gathering, featuring key takeaways from industry leaders and innovators.",
    author: "The Media Collective",
  ...
  },
  {
    ...
    excerpt: "Why genuine connections matter more than ever in today's fast-paced media environment, and how to cultivate them effectively.",
    author: "The Media Collective",
          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-muted-foreground text-lg">
                Stay informed with the latest industry insights, event recaps, and community updates from The Media Collective.
              </p>
            </div>
          </div>
        </section>
