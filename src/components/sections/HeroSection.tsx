            ...
            >
              ...
              >
                <Button 
                  ...
                  className="bg-accent text-accent-foreground hover:bg-accent/90 font-body uppercase tracking-wider text-sm px-10 py-7 shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-accent-foreground/20"
                >
                  Register Interest
