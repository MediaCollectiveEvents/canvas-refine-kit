...
export default function PageHero({
  ...
  const titleGlowKeyframes = [
    ...
    "radial-gradient(circle, rgba(190,154,255,0.24) 0%, transparent 70%)",
    ...
    <header className="relative w-full min-h-[70vh] md:min-h-[80vh] flex items-center justify-center text-center overflow-hidden">
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          {description && (
            <p className="text-primary max-w-xl mx-auto text-base sm:text-lg md:text-xl font-body leading-relaxed mb-12">
              {description}
            </p>
          )}
      ...
      {/* ⭐ CLEAN CRISP NEON LINE – MATCHES HEADER EXACTLY */}
      <div
        className="
